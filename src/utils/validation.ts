...
function validateProperty(value: any, schema: any, propertyName: string): ValidationResult {
  const errors: string[] = [];
  const warnings: string[] = [];
...
export function validateColorValue(color: string): ValidationResult {
  const errors: string[] = [];
  const warnings: string[] = [];
...
export function validateSpacingValue(spacing: string | number): ValidationResult {
  const errors: string[] = [];
  const warnings: string[] = [];
...
export function validateTypographyValue(typography: any): ValidationResult {
  const errors: string[] = [];
  const warnings: string[] = [];
